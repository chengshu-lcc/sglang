...
from config.exceptions import FtRuntimeException, ExceptionType
...
class GenerateConfig(BaseModel):
    ...
    def to_generation_config(self):
        return GenerationConfig(
            ...
            stop_strings=self.stop_words_str,
            use_cache=True,
    ...
    def update_by_pretrain_generation_config(self, generation_config):
        #self.stop_words_str = generation_config.stop_strings
