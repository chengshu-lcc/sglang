...
class ParallelInfo(object):
    ...
    def __init__(
        ...
        self.node_rank = self.world_rank // (self.world_size // self.node_size)
    ...
    def from_params(params: Dict[str, str]) -> ParallelInfo:
        info = ParallelInfo(
                ...
                node_size = int(params.get('NODE_SIZE', '1')))
...
class WorkerInfo(object):
    def __init__(self, ip: str, server_port: int, node_rank: int, gang_hb_port: int, http_port: int, rpc_server_port: int, remote_rpc_server_port: int, cache_store_listen_port: int, cache_store_connect_port: int, cache_store_rdma_listen_port: int, cache_store_rdma_connect_port: int, name: str, info: Any):
        self.ip = ip
    ...
    def from_env():
        info = WorkerInfo(
            ...
            node_rank=g_parallel_info.node_rank,
